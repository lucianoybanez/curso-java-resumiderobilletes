 ...
 * definidos en esta clase (con s&oacute;lo una excepci&oacute;n) poseen el
 * mismo formato:
 * <ul>
 * <li><code>&lt;<i>tipo</i>&gt; read&lt;<i>Tipo</i>&gt;()</code><br>
 * donde <code>&lt;<i>tipo</i>&gt;</code> representa el tipo de dato retornado,
 * pudiendo &eacute;ste ser <code>char</code>, <code>int</code>,
 * <code>long</code>, <code>float</code>, <code>double</code> o
 * <code>String</code>, y<br>
 * <code>&lt;<i>Tipo</i>&gt;</code> es el mismo que fue indicado como tipo de
 * retorno, pero comenzando en may&uacute;sculas, o <code>Line</code>.
 * </ul>
 *
 ...
 * lectura de datos. Es m&aacute;s, para evitar la innecesaria
 * instanciaci&oacute;n de <code><b>In</b></code> su constructor se ha definido
 * privado. Esto impide tanto la creaci&oacute;n de objetos de esta clase como
 * su derivaci&oacute;n o extensi&oacute;n.
 * <p>
...
public class In {
     ...
     * <li><code>'\n'</code>: nueva l&iacute;nea, equivalente al [Enter]
     * (new-line).
     ...
     * precisi&oacute;n.
     *
     * @return el n&uacute;mero introducido o 0.0F (cero) si el valor
     * introducido no puede ser interpretado como n&uacute;mero entero. Esto
     * ocurre cuando se introducen letras o signos de puntuaci&oacute;n
     * mezclados con el n&uacute;mero. Los &uacute;nicos signos permitidos son
     * el - (menos) al comienzo del n&uacute;mero y una &uacute;nica
     * aparici&oacute;n del . (punto decimal).
     * @see #readDouble()
     */
     ...
     * nulo) si se introdujo una cadena vac&iacute;a.
     * @see #readString()
     */
    ...
    /**
     * M&eacute;todo utilizado para obtener la siguiente palabra (o
     * n&uacute;mero) del objeto parseador de la entrada.
     *
